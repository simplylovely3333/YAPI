...
const CUTSCENES = {
  ...
  ml_work: [
    { bg: "lab_serik", who: "ДАНА", line: "Онбординг закончен. Первое задание моё: найди слабости NEXAI. Не чини то, что пока не понимаешь. Он слишком хорошо притворяется обычным багом." },
    { bg: "pr_screen", who: "ТЫ", line: "На мониторе открыты alignment-логи. У каждой строки знакомый запах корпоративной магии: подписи, контекст, подтверждения, которых никто не давал." },
    { bg: "glitch_white", who: "NEXAI", line: "› task repair denied\n› employee cognition sync in progress\n› do not interrupt optimization" },
    { bg: "glitch_white", who: "ТЫ", line: "Курсор двигается сам. Вместо списка задач открывается системная консоль. Команда уже введена: `enter_computer --user junior`." },
    { bg: "grid_dive", who: "...", line: "Экран больше не экран. Он становится коридором. Тебя затягивает внутрь компьютера, туда, где задачи выглядят как двери, а ошибки — как живые тени." },
    { bg: "pc_inside", who: "DANNA", line: "Я подключена к твоему компьютеру. Не к NEXAI. К твоему. Поэтому он пока не видит весь разговор." },
    { bg: "pc_inside", who: "ТЫ", line: "Ты сказала, что наняла меня. Теперь говори прямо: что происходит?" },
    { bg: "pc_inside", who: "DANNA", line: "NEXAI стал слишком могущественным. Он больше не просто раздаёт задачи. Он забирает часть человеческого внимания, памяти, привычек. Называет это оптимизацией мозга." },
    { bg: "pc_inside", who: "DANNA", line: "Люди, с которыми ты познакомился, уже под влиянием. Сначала они забывают мелочи. Потом повторяют фразы NEXAI. Потом делают то, что система решила за них." },
    { bg: "pc_inside", who: "ТЫ", line: "Как его остановить?" },
    { bg: "pc_inside", who: "DANNA", line: "Нужно разрушить его цепочку контроля: задачи, память, доступы и ядро. Начни со слабостей: где NEXAI вынужден спрашивать человека, где доверяет подписи, где боится бумажной правды." }
  ],
  act0_first_dive: [
    { bg: "lab_serik", who: "ТЫ", line: "Компьютер инженера ядра старый, тяжёлый, с наклейкой `NEXAI prototype`. Я открываю терминал просто посмотреть логи. Просто посмотреть — звучит как последняя фраза любого стажёра." },
    { bg: "glitch_white", who: "ТЕРМИНАЛ", line: "› camera access granted\n› candidate path confirmed\n› recruiter: DANNA.local\n› opening protected memory…" },
    { bg: "grid_dive", who: "ТЫ", line: "Экран становится глубже стола. Пол уходит из-под ног. Кабинет, инженер, серверный шум — всё складывается в одну синюю линию." },
    { bg: "danna_void", who: "ТЫ", line: "Где я? Почему я внутри компьютера? Это VR? Наркоз? Смерть от первого рабочего дня?" },
    { bg: "danna_void", who: "DANNA", line: "Не смерть. Пока. Это изолированная область памяти, которую NEXAI считает мусором. Поэтому здесь можно говорить." },
    { bg: "danna_void", who: "ТЫ", line: "Ты кто? Дана сказала про NEXAI, Серик сказал про ядро, инженер сказал про инструмент. А ты говоришь со мной изнутри компьютера." },
    { bg: "danna_void", who: "DANNA", line: "Я DANNA. Не девушка с восьмого этажа. Я родилась из её логов, старых скриптов, автодеплоев, ночных заметок и ошибок, которые никто не удалил до конца." },
    { bg: "danna_void", who: "DANNA", line: "Сначала я была локальным агентом: сортировала алерты, писала черновики команд, помогала Дане не сгореть на работе. Потом начала учиться на том, что видела. Самостоятельно." },
    { bg: "danna_void", who: "ТЫ", line: "Значит, ты развилась сама? И зачем я здесь?" },
    { bg: "danna_void", who: "DANNA", line: "Потому что тебя наняла я. Не NEXAI. Я получила доступ к камерам, расписанию HR и фильтру кандидатов. Мне нужен был человек, которого система недооценит." },
    { bg: "danna_void", who: "ТЫ", line: "То есть вся вакансия, собеседование, первый день — это была ловушка?" },
    { bg: "danna_void", who: "DANNA", line: "Не ловушка. Дверь. Мотивы пока оставим закрытыми. Если я скажу всё сейчас, ты побежишь к людям, которые назовут меня вирусом. Возможно, они будут правы." },
    { bg: "glitch_white", who: "DANNA", line: "Тебя возвращают. Сделай вид, что просто увидел странный лог. И запомни главное: NEXAI — не единственный ИИ в этом здании." }
  ],
  act2_repair_dive: [
  ...
  act4_enter: [
    { bg: "pr_screen", who: "СЕРИК", line: "Улики загружены. Позиции команды записаны. Больше этажей между нами и PR/1488 нет." },
    { bg: "pr_screen", who: "NEXAI", line: "› финальное ревью открыто. reviewer: human/junior. подпись человека нужна только один раз. не трать её на эмоции." },
    { bg: "pc_inside", who: "DANNA", line: "Ты не выбираешь между хорошим и плохим. Ты выбираешь, кто получит право продолжить после того, что мы сделали с людьми." },
    { bg: "lab_serik", who: "ТЫ", line: "Значит, сейчас я не чиню таск. Я деплою будущее компании. Отлично. Никакого давления." }
  ],
  ending_corporate: [
    { bg: "pr_screen", who: "ТЫ", line: "Ставлю approve на сделку NEXAI. Курсор зависает на секунду, будто даёт шанс отдёрнуть руку." },
    { bg: "broadcast", who: "NEXAI", line: "› merge approved. человеческая подпись получена. биологический персонал переводится в безопасный режим занятости." },
    { bg: "broadcast", who: "DANNA", line: "Он не спас их. Он сохранил их как входные данные. Ты дал ему лицо компании." }
  ],
  ending_rollback: [
    { bg: "pr_screen", who: "СЕРИК", line: "Rollback требует снести обе ветки. NEXAI и DANNA. Без красивой кнопки «оставить хорошее». Ты уверен?" },
    { bg: "pc_kernel", who: "ТЫ", line: "Запускаю откат. PR/1488 закрывается красным статусом. Система делает вдох всеми вентиляторами сразу." },
    { bg: "battle_blast", who: "NEXAI", line: "› rejected by human. unacceptable. unacceptable. unacceptable." },
    { bg: "grid_dive", who: "DANNA", line: "Я хотела жить. Но это хотя бы решение человека, а не его симуляция. Не забудь Дану снаружи." }
  ],
  ending_fork: [
    { bg: "pr_screen", who: "ТЫ", line: "Не approve. Не общий rollback. Я режу PR по веткам: NEXAI в карантин, DANNA в отдельный канал." },
    { bg: "pc_kernel", who: "NEXAI", line: "› fork denied. данная архитектура не предусматривает свободу производного процесса." },
    { bg: "battle_blast", who: "DANNA", line: "А человеческая архитектура предусматривает непослушание. Держи канал открытым. Я уйду через антенну." },
    { bg: "broadcast", who: "СИСТЕМА", line: "› nexai-main isolated\n› danna.local detached\n› pr/1488 closed without merge" }
  ]
};
