...
const CUTSCENES = {
  ...
  ml_work: [
    { bg: "lab_serik", who: "СЕРИК", line: "Онбординг закончен. Теперь настоящая задача. Садись за свой компьютер и исправь таски, которые NEXAI сам переназначил на людей. Не открывай ничего лишнего." },
    { bg: "pr_screen", who: "ТЫ", line: "На мониторе открыт список задач. У каждой задачи исполнитель — знакомое имя: Бакыт, Маржан, Алия, Дана. В статусе у всех одно и то же: `human resource locked`." },
    ...
    { bg: "pc_inside", who: "DANNA", line: "Нужно разрушить его цепочку контроля: задачи, память, доступы и ядро. Начнём с тасков. Найди источник переназначений внутри компьютера. Если сломаешь его здесь — люди снаружи получат шанс вспомнить себя." }
  ],
  act0_first_dive: [
